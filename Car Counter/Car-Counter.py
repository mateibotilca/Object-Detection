    ...
    for r in results:
        ...
        for box in boxes:
            ...
            if currentClass == "car" or currentClass == "truck" or currentClass == "bus" or currentClass == "motorbike"\
                ...
                # cvzone.cornerRect(img, (x1, y1, w, h), l=8, rt=5, colorR=(255, 0, 0), colorC=(0, 0, 255))
                currentArray = np.array([x1, y1, x2, y2, conf])
                detections = np.vstack((detections, currentArray))

    resultsTracker = tracker.update(detections)
    cv2.line(img, (limits[0], limits[1]-30), (limits[2], limits[3]-30), color=(0, 255, 0), thickness=2)
